...
def Do(df_var,big_df):
    ...
    for i in range(tam):  
        ...
        title,count,mean,mode,stdDev,r0,r1,r2,r3,r4,r1_graph,r2_graph,r3_graph,r4_graph = statistics.Do(aux_df,nomevar)
        ...
        #Carregar graficos
        df_var.loc[df_var['variavel']==nomevar,'r1_graph'] = r1_graph
        df_var.loc[df_var['variavel']==nomevar,'r2_graph'] = r2_graph
        df_var.loc[df_var['variavel']==nomevar,'r3_graph'] = r3_graph
        df_var.loc[df_var['variavel']==nomevar,'r4_graph'] = r4_graph
