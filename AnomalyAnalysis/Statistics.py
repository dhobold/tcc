...
def Do(aux_df,nome_var):     
    ...
    if df.empty:
        ...
        r3_graph = ''
        r4_graph = ''
        return nome_variavel,count,mean,mode,stdDev,r0,r1,r2,r3,r4,r1_graph,r2_graph,r3_graph,r4_graph
    ...
    r1, r1_graph = ch.timeLine(df,nome_var)      
    r2, r2_graph = ch.timelineOficial3(df,nome_var)    
    r3, r3_graph = ch.histograma(df,nome_var)
    r4, r4_graph = ch.boxplot(df,nome_var)   
